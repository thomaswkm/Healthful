...
public class VentanaFormularioMedico extends Ventana {
    ...
    public VentanaFormularioMedico(Healthful healthful, Usuario usuario) {
        super("Formulario Médico", 500, 520);
    ...
    private void generarElementosVentana() {
        ...
        generarListaEspecialidades();
        generarBotonCancelar();
        generarBotonContinuar();
    }

    private void generarListaEspecialidades() {
        super.generarJLabel("Especialidad:", 20, 300, 150, 20);
        String[] especialidades = healthful.getEspecialidades().toArray(String[]::new);
        listaEspecialidades = super.generarListaDesplegable(especialidades, 200, 300, 250, 20);
        listaEspecialidades.setSelectedIndex(-1);
        listaEspecialidades.addActionListener(this);
        this.add(listaEspecialidades);
    }
    ...
    private void generarEncabezado() {
        String textoCabecera = "Complete Ficha del Médico";
...
//            new VentanaConfirmacionNuevoPaciente(healthful, usuario, crearMedico());
            new VentanaConfirmacionNuevoMedico(healthful, usuario, crearMedico());
            this.dispose();
        }
    ...
    private void validarCampos() {
        ...
        int especialidadesSelectedIndex = listaEspecialidades.getSelectedIndex();

        if (nombre.isBlank() || apellido.isBlank() || fecha == null ||
                sexoSelectedIndex == -1 || estadoCivilSelectedIndex == -1 || especialidadesSelectedIndex == -1) {
